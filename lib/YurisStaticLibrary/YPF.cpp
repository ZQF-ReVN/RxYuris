...
namespace YurisLibrary
{
	namespace YPF
	{
		...
		YPF_V5::YPF_V5(std::wstring wsFile) :
			m_Header({ 0 }),
			m_wsYPF(wsFile)
		{
		...
		unsigned char YPF_V5::DecodePathSize(unsigned char szEncFileName)
		{
		...
		void YPF_V5::DecodePathName(char* lpEncFileName, size_t szFileName)
		{
			if (szFileName > 0)
			{
